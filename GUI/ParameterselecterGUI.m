...
% --- Otherwise, executes on mouse press in 5 pixel border or over runModelButt.
function runModelButt_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to runModelButt (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
