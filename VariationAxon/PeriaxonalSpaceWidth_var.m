function par = PeriaxonalSpaceWidth_var(mean, sd, seed)
...
par.myel.geo.peri.value.ref =                                           mean;
par.myel.geo.peri.value.vec =                                           normrnd(par.myel.geo.peri.value.ref, sd, par.geo.nintn,1)*ones(1,par.geo.nintseg);
...
% Myelin width.
par.myel.geo.width.value.ref =                                          0.11;
par.myel.geo.width.value.vec =                                          par.myel.geo.width.value.ref *ones(par.geo.nintn, par.geo.nintseg);
