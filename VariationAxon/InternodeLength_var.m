function par = InternodeLength_var(mean, sd, seed)
...
% Internode length.
par.intn.geo.length.value.ref =                                         mean-2*par.paranode.length;
par.intn.geo.length.value.vec =                                         normrnd(par.intn.geo.length.value.ref, sd, par.geo.nintn,1);
