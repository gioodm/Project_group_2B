function par = all_var(mean, sd, seed)
...
% Internode length.
par.intn.geo.length.value.ref =                                         mean(1)-2*par.paranode.length;
par.intn.geo.length.value.vec =                                         normrnd(par.intn.geo.length.value.ref, sd(1), par.geo.nintn,1);
...
par.myel.geo.peri.value.ref =                                           mean(3);
par.myel.geo.peri.value.vec =                                           normrnd(par.myel.geo.peri.value.ref, sd(3), par.geo.nintn,1)*ones(1,par.geo.nintseg);
...
% Myelin width.
par.myel.geo.width.value.ref =                                          mean(2);
par.myel.geo.width.value.vec =                                          normrnd(par.myel.geo.width.value.ref, sd(2), par.geo.nintn,1)*ones(1,par.geo.nintseg);
